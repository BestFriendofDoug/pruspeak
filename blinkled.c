...
void main()
{
	...
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 96, GPIO_PIN_LOW);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 105, GPIO_PIN_LOW);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 18, GPIO_PIN_LOW);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 16, GPIO_PIN_LOW);

	for(i=0;i<0x00a00000;i++);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 96, GPIO_PIN_HIGH);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 105, GPIO_PIN_HIGH);
	GPIOPinWrite(GPIO_INSTANCE_ADDRESS, 18, GPIO_PIN_HIGH);
